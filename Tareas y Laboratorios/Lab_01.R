...
#Comencemos a escribir cosas básicas en la consola, usando R como calculadora cientíﬁca. Por ejemplo, considere las facturas mensuales de una estudiante universitaria de la MCF: teléfono celular $300, transporte $ 240, comestibles $ 1527, gimnasio $ 400, alquiler $ 1500, otros $ 1833. Puede usar R para encontrar los gastos totales de la estudiante:
...
#Toma los objetos creados de la estudiante (i.e variables) tansporte, comestibles, gimnasio, alquier y otros y esciribamos dentro de la función de combinación c() para crear un vector de gastos:

gastos <- c(celular, transporte, comestibles, gimnasio, alquiler, otros)

barplot (gastos, main = "Gastos", names.arg = c("Celular", "Transporte", "Comestibles", "Gimnasio", "Alquiler", "Otros"), 
        col = rainbow (6))
...
barplot(Gastosdecreciente, main = "Gastos Decreciente", names.arg = c("Otros", "Comestibles", "Alquiler", "Gimnasio", "Celular", "Transporte"),
                                                                      col = "orchid1")
